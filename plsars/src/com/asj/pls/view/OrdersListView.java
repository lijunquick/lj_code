...
public class OrdersListView extends ListView implements OnScrollListener{
    ...
    public OrdersListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        headerView = (LinearLayout) inflater.inflate(R.layout.layout_orders_header, null);
        ...
        //下滑刷新
        footer = inflater.inflate(R.layout.layout_orders_footer, null);
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
    	if (totalItemCount == lastVisibleItem && scrollState == SCROLL_STATE_IDLE) {
			if (!isLoading) {
				...
				this.setSelection(ListView.FOCUS_DOWN);
				// 加载更多
    ...
    public void setAdapter(OrdersAdapter adapter) {
