...
public class CartActivity extends Activity implements OnClickListener,CartListener{
     ...
     * 清空购物车所以商品
     */
    public ImageView clearCartPd,backCart;
	...
	private void initView(){
		...
		conText = (TextView) findViewById(R.id.my_cart_consignee);
		mobText = (TextView) findViewById(R.id.my_cart_mobile);
		addrText = (TextView) findViewById(R.id.my_cart_address);
		cartFreePrice = (TextView) findViewById(R.id.cart_free_price);
		cartPriceTotal = (TextView) findViewById(R.id.cart_price_total);
		cartGoWrite = (TextView) findViewById(R.id.cart_go_write);
		footCartView = (RelativeLayout) findViewById(R.id.cart_foot);
		cartListView = (ListView) findViewById(R.id.cart_ListView);
		clearCartPd = (ImageView) findViewById(R.id.clearall_cart_pd);
		cartNoPd = (LinearLayout) findViewById(R.id.cart_no_pd);
		goIndex = (Button) findViewById(R.id.go_index);
		backCart = (ImageView) findViewById(R.id.back_index_cart);
	...
	public void onClick(View v) {
		...
		case R.id.cart_go_write://去填单页
			Intent intent = new Intent(CartActivity.this,FillSingleActivity.class);
		...
		public void handleMessage(android.os.Message msg) {
			try {
				if(cartJson != null){
					...
					if(cartObject.getString("buyPrice") != null && !cartObject.getString("buyPrice").equals("0")){
						cartFreePrice.setText("满" + cartObject.getString("buyPrice") +"起送");
					}
